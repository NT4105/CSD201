...
public class Lib {
   ...
   // Read line k (k=0,1,2,...) and extracts it to thearray strings and return this
   // array
   ...
   // Read line k (k=0,1,2,...) and extracts it to the array of integers and return
   // this array
   ...
   // Read line k (k=0,1,2,...) and extracts it to the array of double numbers and
   // return this array
   ...
   // Display elements of the array of strings from idex k to index h, k>=0. k<=h
   // and h<=a.length-1
   ...
   // Display elements of the array of inttegers from idex k to index h, k>=0. k<=h
   // and h<=a.length-1
   ...
   // Display to file elements of the array of strings from idex k to index h,
   // k>=0. k<=h and h<=a.length-1
